...
<p>We want to talk honestly about it — because the way most of us have been taught to think about money and self-investment is specifically designed to keep us from choosing ourselves.</p>

<h2>Let's put the number in context</h2>
<p>A 5-day retreat that includes accommodation, all meals, experiences, and facilitation — compared to what?</p>

<ul>
<li>A week at a resort where you come home rested but unchanged → similar price, different outcome</li>
<li>Months of therapy, wellness purchases, courses, and self-help books → often more, over time</li>
<li>The cost of continuing as you are — chronic stress, relationships that suffer, opportunities you don't take → incalculable</li>
</ul>

<p>We're not saying it's not a real investment. It is. We're saying it's worth asking: <em>compared to what?</em></p>

<h2>Practical ways women make it happen</h2>
<ul>
<li><strong>Ask for it as a gift</strong> — birthday, milestone, holiday. Share the link. Make the ask. The women in your life who want to support you need to know what you actually want</li>
<li><strong>Start a dedicated savings fund</strong> — even $200/month set aside 12 months out makes a retreat achievable for most people. Name the account something that reminds you what it's for</li>
<li><strong>Use travel points</strong> — the right credit card can cover your flights entirely. Many women offset or eliminate flight costs this way</li>
<li><strong>Talk to your employer</strong> — if the retreat has elements of resilience or burnout recovery, some women have made this case successfully as professional development</li>
<li><strong>Notice what you'll stop spending</strong> — the month before a retreat, women naturally spend less on the things they were using to cope with the life they haven't changed yet</li>
</ul>

<h2>The harder question</h2>
<p>What would you tell your best friend if she said: <em>"I really want to go but I can't afford to prioritize myself right now"?</em></p>
...
<p>Our retreats in <a href="/retreats/mexico">Mexico</a>, <a href="/retreats/morocco">Morocco</a>, and <a href="/retreats/kenya">Kenya</a> are priced to include as much as possible — no surprise costs when you arrive. If you have questions about what's included, <a href="/contact">we're happy to walk you through it</a>.</p>
    `.trim(),
  },
  {
...
<p><strong>The theme</strong> — identity. Becoming who you actually are underneath the roles, the expectations, the version of yourself you built for everyone else.</p>

<p><strong>You might be drawn here if:</strong></p>
<ul>
<li>You're in a transition or shedding a skin</li>
<li>You feel like you've lost yourself a little</li>
<li>You want warmth, nature, and something contained</li>
...
<p><strong>The theme</strong> — coming home to yourself. The Moroccan desert has been a place of pilgrimage and reflection for centuries. The silence and scale of it puts everything in perspective.</p>

<p><strong>You might be drawn here if:</strong></p>
<ul>
<li>You want something that feels truly different from your everyday life</li>
<li>You've always felt pulled to Morocco</li>
<li>You need the kind of silence only a desert can give you</li>
...
<p><strong>The theme</strong> — belonging. To nature, to other women, to yourself. There's something that happens in the wild that's hard to manufacture anywhere else.</p>

<p><strong>You might be drawn here if:</strong></p>
<ul>
<li>Africa has always felt like a calling</li>
<li>You want the most immersive nature experience</li>
<li>You're ready for something that will genuinely take your breath away</li>
<li>You want 7 days with safari mornings and healing afternoons</li>
</ul>

<h2>Still not sure?</h2>
<p>Trust the pull. If one of these keeps coming back into your mind, that's information.</p>
...
<p>She's capable, competent, and completely exhausted. She's the one people call when things go wrong. She's been the strong one for so long she's forgotten she's allowed to need something too.</p>
<p>→ She books the retreat nervously, convinced she doesn't have time. She comes back saying it was the most important thing she's done in years.</p>

<h2>The woman at a crossroads</h2>
<p>A relationship ending. A career that no longer fits. A life that made sense five years ago and doesn't anymore.</p>
<p>→ She's not broken — she's between versions of herself. She needs space to figure out who she's becoming, away from the noise of her regular life.</p>

<h2>The woman who gave herself away</h2>
<p>In a relationship, in motherhood, in a job that required everything. She's been so focused on what everyone else needs that she genuinely doesn't know what she wants anymore.</p>
<p>→ The retreat is the first time in years she's done something purely for herself. The first morning she wakes up without a responsibility, she cries and doesn't know why. By the last day, she does.</p>

<h2>The woman who is already doing the work</h2>
<p>She meditates. She sees a therapist. She reads the books. She's not coming to start her healing — she's coming to go deeper, and to be in community with other women doing the same.</p>
<p>→ She leaves with a circle of women she's known for five days and will know for life.</p>

<h2>The woman who almost didn't come</h2>
<p>She talked herself out of it twice. She almost cancelled the week before. Something in her kept saying: you don't deserve this, you can't afford it, the timing isn't right.</p>
<p>→ She came anyway. She is consistently the one who says: <em>I almost didn't come, and I can't imagine who I'd be right now if I hadn't.</em></p>

<h2>What they all have in common</h2>
<ul>
<li>They're done waiting for the right time</li>
<li>They know, at some level, that something needs to shift</li>
<li>They've chosen — however nervously — to say yes to themselves</li>
</ul>

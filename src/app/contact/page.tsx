      ...
      <section style={{ background: "var(--color-bg-page)", padding: "80px 32px 80px 0" }}>
        <div style={{ maxWidth: 1400, margin: "0 auto", display: "grid", gridTemplateColumns: "280px 1fr 1fr", gap: 48, alignItems: "center" }} className="contact-split">
          ...
          <div style={{ paddingLeft: 32, display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center" }}>
            ...
            <FadeIn delay={0.1}>
              <h1 style={{ fontFamily: "var(--font-fraunces)", fontSize: "clamp(24px,3vw,32px)", color: "var(--color-text-headline)", fontWeight: 700, marginBottom: 24 }}>
                let&apos;s talk
              </h1>
            </FadeIn>
            <FadeIn delay={0.2}>
              <p style={{ fontFamily: "var(--font-dm-sans)", fontSize: 15, color: "var(--color-text-body)", lineHeight: 1.9, marginBottom: 32 }}>
            ...
            <FadeIn delay={0.3}>
              <a
                ...
                style={{ display: "inline-block", padding: "12px 24px", background: "var(--color-accent)", border: "1px solid var(--color-accent)", color: "#FFFCF5", fontFamily: "var(--font-dm-sans)", fontSize: 12, letterSpacing: "0.04em", textDecoration: "none", transition: "opacity 0.2s ease, transform 0.2s ease" }}
        ...
        <style>{`@media(max-width:900px){.contact-split{grid-template-columns:1fr!important;padding-left:32px!important}}`}</style>
      </section>
